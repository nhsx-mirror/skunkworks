...
# Long Stayer Risk Stratification

<Tags title="" tags={['LoS','length of stay','neural network','risk model']} />

> Machine learning using historical data from Gloucestershire Hospitals NHS Foundation Trust to predict how long a patient will stay in hospital upon admission.
