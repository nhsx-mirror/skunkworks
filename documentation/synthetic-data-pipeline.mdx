...
![Kedro Pipeline Structure]([upload pic of pipeline structure and insert link here])
...
Get in touch with the Skunkworks team at [aiskunkworks@nhsx.nhs.uk](mailto:aiskunkworks@nhsx.nhs.uk).


Output|Link
---|---
Open Source Code & Documentation|[Github]([COMING SOON])
Case Study|[Case Study]([LINK TO PUBLIC VERSION HERE?])
